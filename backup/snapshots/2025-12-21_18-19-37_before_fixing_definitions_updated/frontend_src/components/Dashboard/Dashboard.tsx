          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Valuta la sicurezza del tuo dispositivo e rete</p>
              </div>
            </div>
            <button
              onClick={handleScan}
        ...
        {isScanning && scanProgress && (
          <div className="card mb-8">
            <div className="flex items-center gap-4">
              <Activity className="w-6 h-6 text-primary-600 animate-spin" />
              ...
              <span className="text-2xl font-bold text-gray-700">{scanProgress.progress}%</span>
            </div>
          </div>
        )}
          ...
          <>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="card col-span-1">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Rating Complessivo</h2>
                <RatingGauge score={scanData.rating.overall} />
              </div>

              {/* Category Breakdown */}
              <div className="card col-span-1 lg:col-span-2">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Dettaglio Categorie</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="card">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800">Punti di Forza</h3>
                </div>
                {scanData.rating.strengths.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500">Nessun punto di forza rilevato</p>
                )}
              </div>
              ...
              <div className="card">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800">Raccomandazioni</h3>
                </div>
                {scanData.rating.recommendations.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-500">Nessuna raccomandazione</p>
                )}
              </div>
            </div>
